...
BEGIN -- 코드를 실행하는 시작 구간(실행부)
    ...
    emp_num := 10; -- :=  -> 대입 연산자
    DBMS_OUTPUT.put_line('Hello pl/spl~!');--sysout와 같음
...
DECLARE
    v_emp_name VARCHAR2(50); --사원명 변수 (문자열 변수는 길이 제약 필요)
...
DECLARE
    v_emp_name employees.first_name%TYPE; --사원명 변수 (문자열 변수는 길이 제약 필요)
