...
GRANT CREATE SESSION TO user1; -- 생성 권한 주기

GRANT SELECT ON hr.departments TO user1; --조회 권한 주기
...
GRANT RESOURCE, CONNECT, DBA to user1; --관리자와 동등 권리 줌
-- -> 어떤 테이블이든 다 접근 가능

REVOKE RESOURCE, CONNECT, DBA FROM user1; --권한 회수
